...
namespace Server.Commands
{
    public static class CommandHandlers
    {
        ...
        [Usage("Help")]
        [Description("Opens Rucci's Player Readme Page")]
        public static void Help_OnCommand(CommandEventArgs e)
        {
            var pm = e.Mobile as PlayerMobile;
            pm.LaunchBrowser("https://github.com/colcomet/ModernUO/wiki/Rucci's-UO-Shard-Player-Readme");
        }
        ...
        {
            e.Mobile.SendMessage($"Open Connections: {NetState.Instances.Count}");
