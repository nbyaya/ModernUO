...
namespace Joeku.SR
{
    public class SR_Gump : Gump
    {
        ...
        {
            mob.CloseGump<SR_Gump>(); // Updated to use the generic CloseGump method
        ...
        public void DisplayRunes(int y, int h, int labelHue)
        {
            ...
            for (int i = 0, loc = 0, page = 1; i < count; i++, loc++)
            {
                ...
                AddButton(390, temp, 4017, 4019, i + 60010, GumpButtonType.Reply, 0);
        ...
        public override void OnResponse(NetState sender, in RelayInfo info)
        {
            ...
            switch (button)
            {
                ...
                default:
                    ...
                    else if (RuneAcc.ChildRune != null && button >= 0 && button < RuneAcc.ChildRune.Runes.Count)
                        rune = RuneAcc.ChildRune.Runes[button];

                    if (rune != null && rune.IsRunebook)
                    {
                        if (RuneAcc.ChildRune == null)
                    ...
                    {
                        if (rune != null && mob.Location == rune.TargetLoc && mob.Map == rune.TargetMap)
                        ...
                        else
                        {
                            ...
                            else if (rune != null && SR_Utilities.FindItem(typeof(Moongate), rune.TargetLoc, rune.TargetMap))
